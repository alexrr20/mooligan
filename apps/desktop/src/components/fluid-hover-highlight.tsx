...
import { motion, AnimatePresence, useReducedMotionConfig, type Transition } from "motion/react";
import * as stylex from "@stylexjs/stylex";
import { uiColors, uiRadii } from "./ui/theme.stylex";
...
export function FluidHoverHighlight(props: FluidHoverHighlightProps) {
  ...
  // Honour both the system setting and Mooligan's MotionConfig preference.
    ...
    <AnimatePresence>
      {rect && (
        <motion.div
          ...
          className={[stylex.props(styles.highlight).className, className]
            .filter(Boolean)
            .join(" ")}
