...
export const browseStyles = stylex.create({
  page: { display: "grid", gap: "28px", paddingBlock: "8px 40px", minWidth: 0 },
  header: {
    display: "flex",
  ...
  toolbar: { display: "flex", alignItems: "center", flexWrap: "wrap", gap: "12px 20px" },
  resultsBar: {
    display: "flex",
    alignItems: "center",
    justifyContent: "space-between",
  ...
  viewGroup: { padding: "3px", backgroundColor: "#171817", borderRadius: "9px" },
  viewItem: {
    borderWidth: 0,
    width: "34px",
    height: "32px",
