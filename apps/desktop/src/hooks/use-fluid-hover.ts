// Fluid Functionalism: https://www.fluidfunctionalism.com/r/use-fluid-hover.json
...
export function useFluidHover<T extends HTMLElement>(
  ...
  const gapClickMaxDistance =
    gapClick !== true && gapClick !== false ? (gapClick.maxDistance ?? Infinity) : Infinity;
