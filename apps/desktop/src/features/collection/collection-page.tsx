...
import { SearchForm } from "../search/search-controls";
...
export function CollectionPage({
  ...
  onSearchChange: (update: CollectionSearchState) => void;
  onClearFilters: () => void;
}) {
  ...
  const searchCollection = useCallback(
    (query: string) => onSearchChange({ query: query || undefined }),
    [onSearchChange],
  );
        ...
        <div>
          ...
          <div {...stylex.props(styles.controls)}>
            <Filter
              ...
              value={search.set ?? ""}
              onChange={(set) => onSearchChange({ set: set || undefined })}
            />
            <Filter
              label="Finish"
              options={[
              ...
              onChange={(finish) => {
                ...
                onSearchChange({ finish: Either.isRight(parsed) ? parsed.right : undefined });
              }}
            />
            <Filter
              label="Language"
              ...
              onChange={(language) => {
                ...
                onSearchChange({ language: Either.isRight(parsed) ? parsed.right : undefined });
              }}
            />
            <Filter
              label="Condition"
              ...
              onChange={(condition) => {
                ...
                onSearchChange({ condition: Either.isRight(parsed) ? parsed.right : undefined });
              }}
            />
            <Filter
              label="Sort"
