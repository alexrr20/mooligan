/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: 1450c8d53b6be09416c6646042c546fe)
// Runtime types generated with workerd@1.20260721.1 2026-07-28 enable_request_signal,nodejs_compat
interface __BaseEnv_Env {
  DB: D1Database;
  BETTER_AUTH_URL: "https://mooligan-api.bessa.workers.dev";
  BETTER_AUTH_TRUSTED_ORIGINS: '["https://mooligan-api.bessa.workers.dev","com.mooligan.app:/"]';
  BETTER_AUTH_SECRET: string;
  GOOGLE_CLIENT_ID: string;
  GOOGLE_CLIENT_SECRET: string;
  SYNC_CREDENTIAL_SECRET: string;
  SYNC_BACKEND: DurableObjectNamespace<import("./index").WorkspaceSyncBackend>;
}
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import("./index");
    durableNamespaces: "WorkspaceSyncBackend";
  }
